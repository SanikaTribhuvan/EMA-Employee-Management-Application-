<script>
    // Update page title
    document.getElementById('pageTitle').textContent = 'Edit Employee - Employee Management System';
</script>
...
<div class="form-container" data-testid="container-form">
    <div class="form-card">
        <div class="form-header">
            <h1 class="form-title">
                <div class="employee-avatar-large" data-testid="avatar-employee">
                    <?= substr($employee->name, 0, 1) . (strpos($employee->name, ' ') ? substr($employee->name, strpos($employee->name, ' ') + 1, 1) : '') ?>
                </div>
                <div>
                    <div class="form-title-main">Edit Employee</div>
                    <div class="form-title-subtitle">
                        <?= htmlspecialchars($employee->name) ?>
                    </div>
                </div>
            </h1>
            <p class="form-description">
                Update employee information. Employee code cannot be modified after creation.
            </p>
        </div>

        <div class="form-body">
            <!-- Employee Info Badge -->
            <div class="employee-info-badge" data-testid="badge-employee-info">
                <i data-lucide="info" class="employee-info-icon"></i>
                <div class="employee-meta">
                    <div class="employee-meta-title">Current Employee Information</div>
                    <div class="employee-meta-details">
                        ...
                        <div class="employee-meta-item">
                            ...
                            <span>Created: <?= date('M d, Y', strtotime($employee->created_at ?? 'now')) ?></span>
                        </div>
                        <div class="employee-meta-item">
            ...
            <!-- Employee Form -->
            <form method="post" action="<?= base_url('employees/edit/'.$employee->empid); ?>" id="employeeForm" data-testid="form-employee">
                <div class="form-grid">
                    <!-- Full Name -->
                    <div class="form-group">
                        ...
                        <div class="form-help">
                            ...
                            Update the employee's full legal name
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input 
                                ...
                                id="mob" 
                                name="mob" 
                                value="<?= set_value('mob', $employee->mob); ?>" 
                                class="form-input" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="readonly-notice" data-testid="notice-readonly">
                            <i data-lucide="shield"></i>
                            <span>Employee code is locked and cannot be changed after creation for security reasons</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-help">
                            <i data-lucide="info"></i>
                            Update job title or role in the organization
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input 
                                ...
                                id="level" 
                                name="level" 
                                value="<?= set_value('level', $employee->level); ?>" 
                                class="form-input" 
                                min="1" 
                                required
                    ...
                    <div class="form-group">
                        ...
                        <select id="manager" name="manager" class="form-select" data-testid="select-manager">
                            ...
                            <?php foreach($managers as $m): ?>
                                <option value="<?= $m->ename; ?>" <?= ($employee->manager == $m->ename) ? 'selected' : ''; ?>>
                        ...
                        <div class="form-help">
                            <i data-lucide="info"></i>
                            Update the direct reporting manager (optional)
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="mgrid" name="mgrid" class="form-select" data-testid="select-manager-id">
                            <option value="">-- No Manager --</option>
                            <?php foreach($managers as $m): ?>
                                <option value="<?= $m->empid; ?>" <?= ($employee->mgrid == $m->empid) ? 'selected' : ''; ?>>
